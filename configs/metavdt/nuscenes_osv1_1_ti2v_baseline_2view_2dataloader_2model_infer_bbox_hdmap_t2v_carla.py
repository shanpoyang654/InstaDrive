...
infer_mode = 't2v' # TODO: no first frame  't2v' 'i2v'
# mask_training = False # no first frame
loop = 10 # TODO:
whole_scene=True
filter_=False
dataset_version = 'Carla'
if dataset_version == 'NuScenes':
    ...
    # === NuScenesTDataset ===
    train_dataset = dict(
        _class_name="CarlaDataset",
        # ann_file='/mnt/iag/share/data/carla/data/20241112025522001_RandomRun_town05/data_infos.json',
        ann_file='/mnt/iag/share/data/carla/data/20241118081437940_RandomRun_town03/data_infos.json',
    ...
    val_dataset = dict(
        ...
        #ann_file='/mnt/iag/share/data/carla/data/20241119010223944_RandomRun_town01/data_infos.json',
        ann_file='/mnt/iag/share/data/carla/data/20241118082210897_RandomRun_town03/data_infos.json',
        #ann_file='/mnt/iag/share/data/carla/data/20241119072320662_FrontBrake_town03/data_infos.json',
        #ann_file='/mnt/iag/share/data/carla/data/20241119071649554_FrontBrake_town03/data_infos.json',
        #ann_file='/mnt/iag/share/data/carla/data/20241119062910844_RandomRun_town03/data_infos.json',
        #'''
        dataroot='/mnt/iag/share/data/carla/',
        step=num_frames*loop, # TODO:
        modality={
...
# Define acceleration
num_workers = 0 # reduce memory consumption 
...
model = dict(
    ...
    scale_factor=0.25,
    controlnet='dive', # 'dive' 'controlnet' 'sd'
    duplicated_depth=14,
