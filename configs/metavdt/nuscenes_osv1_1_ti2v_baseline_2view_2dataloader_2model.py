...
mask_training = True # TODO:
loop = 1 # TODO:
dataset_version = 'NuScenes_interpolated_12Hz'


annotation_version = {"bbox": 'cross', # 'cross' 'surface' 'none'
                      "hdmap": 'old',# 'old':['drivable_area', 'road_segment', 'lane', 'ped_crossing', 'walkway', 'stop_line']
...
elif annotation_version["hdmap"] == 'no_divider':
    hdmap_path = '/mnt/iag/user/yangzhuoran/dataset/data/hdmap_no_divider' 
...
model = dict(
    ...
    scale_factor=0.25,
    controlnet='dive', # 'dive' 'controlnet' 'sd' 'traj_controlnet' 'traj_dive'
    duplicated_depth=14, # 103-14 98/99-13
    duplicated_same=False, # TODO:
    # depth=28,
    task=2, # layout, traj
)
vae = dict(
...
scheduler = dict(
    ...
    predict_xstart=False, # TODO: False->True
)
...
log_every = 100
ckpt_every = 1000
# load = '/mnt/iag/user/yangzhuoran/local/stable/metavdt/outputs/nuscenes_osv1_1_ti2v_baseline_2view_2dataloader_2model/021-STDiT2-XL-2/epoch0-global_step10000' # containing running_states.json
# load = '/mnt/iag/user/yangzhuoran/local/stable/metavdt/outputs/nuscenes_osv1_1_ti2v_baseline_2view_2dataloader_2model/020-STDiT2-XL-2/epoch0-global_step12000' # bimot
# load = '/mnt/iag/user/yangzhuoran/local/stable/metavdt/outputs/nuscenes_osv1_1_ti2v_baseline_2view_2dataloader_2model/051-STDiT2-XL-2/epoch1-global_step29000' # controldit
# load = '/mnt/iag/user/yangzhuoran/local/stable/metavdt/outputs/nuscenes_osv1_1_ti2v_baseline_2view_2dataloader_2model/021-STDiT2-XL-2/epoch2-global_step44000' # dive
load = None
# load = '/mnt/iag/user/yangzhuoran/local/stable/metavdt/outputs/nuscenes_osv1_1_ti2v_baseline_2view_2dataloader_2model/103-STDiT2-XL-2/epoch2-global_step48000'
# load = '/mnt/iag/user/yangzhuoran/local/stable/metavdt/outputs/nuscenes_osv1_1_ti2v_baseline_2view_2dataloader_2model/099-STDiT2-XL-2/epoch2-global_step53000'
# load = '/mnt/iag/user/yangzhuoran/local/stable/metavdt/outputs/nuscenes_osv1_1_ti2v_baseline_2view_2dataloader_2model/147-STDiT2-XL-2/epoch0-global_step1000' # traj_dive
# load = '/mnt/iag/user/yangzhuoran/local/stable/metavdt/outputs/nuscenes_osv1_1_ti2v_baseline_2view_2dataloader_2model/162-STDiT2-XL-2/epoch3-global_step4000'
# load = '/mnt/iag/user/yangzhuoran/local/stable/metavdt/outputs/nuscenes_osv1_1_ti2v_baseline_2view_2dataloader_2model/164-STDiT2-XL-2/epoch7-global_step10000'
batch_size = 1
lr = 2e-5 
grad_clip = 1.0
