...
from .nuscenes_io import MotionDataset, CanBusExtension, AdditionalImageAnnotation
from torch.utils.data import ConcatDataset
from .nuscenes_t_dataset import NuScenesTDataset
from .carla_dataset import CarlaDataset

from .opendv import MotionOpenDVDataset
...
def prepare_dataloader(
    ...
    **kwargs,
    ...
    if isinstance(dataset, VariableVideoTextDataset):
    ...
    elif isinstance(dataset, VideoTextDataset) or isinstance(dataset, MotionDataset) or isinstance(dataset, ConcatDataset) or isinstance(dataset, MotionOpenDVDataset) or isinstance(dataset, NuScenesTDataset) or isinstance(dataset, CarlaDataset):
        ...
        return (
            DataLoader(
                ...
                collate_fn=collate_fn_default,
                prefetch_factor=prefetch_factor,
                persistent_workers=False, # TODO: add to test num_workers=0
                **_kwargs,
            ),
            sampler,
        )
